                ...
                <form action="{{route('posts.index')}}" method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <a class="btn btn-light" href="{{route('posts.index')}}">Clear</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$post->title}}</td>
                    {{-- <td>{{$post->content}}</td> --}}
                    <td class="{{$post->is_active == 1 ? 'text-success': 'text-danger'}}">{{$post->getActive()}}</td>
                    <td>{{$post->user->name}}</td>
                    <td>{{$post->category->name}}</td>

                    <td nowrap="nowrap">
                        <a class="btn btn-primary" href="{{route('posts.edit',$post->id)}}"><i class="las la-pen"></i></a>
                        ...
                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-toggle="modal"
                            href="#delete{{$post->id}}"><i class="las la-trash"></i></a>
                    </td>
                </tr>
