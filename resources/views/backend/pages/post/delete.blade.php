    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('post.delete_attachment')}}" method="post">
                    @csrf
                    <input type="hidden" name="id" value="{{$attachment->id}}">

                    <input type="hidden" name="post_name" value="{{$attachment->imageable->name}}">
                    <input type="hidden" name="post_id" value="{{$attachment->imageable->id}}">
